...
import { FolderService, type FolderResponse, type FileResponse } from "../folder/services/FolderService";
import EditImageSidebar, { type EditImageSettings } from "./EditImageSidebar";
